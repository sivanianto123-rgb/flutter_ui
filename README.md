...
GitHub API and turns every project folder into a card linking straight to
its GitHub folder, so adding a new one is just:
...
2. Commit and push to `main`. The gallery updates automatically — nothing
